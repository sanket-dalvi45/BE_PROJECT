    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
      <div className="relative p-8 w-full max-w-sm m-auto bg-white rounded-md shadow-lg">
        ...
        <form>
          ...
          <button type="submit" className="w-full bg-purple-600 text-white py-2 rounded-md hover:bg-purple-700 transition-colors cursor-pointer select-none">Sign Up</button>
        </form>
      </div>
    </div>
  );
